...
public class DriverPresenter {
    ...
    public DriverPresenter(Context context){
    ...
    //带参基本请求方法
    public void getDriver(Map<String,String> params){
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getDriver(true,resultModel);
                        }
                    }
                    @Override
    ...
    public void setDriver(Map<String,String> params){
        if (params==null)return;
        Log.e("开始请求","p-->"+params.toString());
        new ApiUtil(context)
                .getServer(ApiService.class)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.setDriver(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
    ...
    public interface OnCallBack{
        void getDriver(boolean isSuccess, Object object);
        void setDriver(boolean isSuccess, Object object);
    }
