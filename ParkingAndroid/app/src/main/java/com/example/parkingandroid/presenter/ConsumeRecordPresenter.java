 ...
 * presenter模板
 */
public class ConsumeRecordPresenter {
    ...
    public ConsumeRecordPresenter(Context context){
    ...
    //带参基本请求方法
    public void getConsumeRecord(Map<String,String> params){
        if (params==null)return;
        Log.e("开始请求","p-->"+params.toString());
        new ApiUtil(context)
                .getServer(ApiService.class)
                //记得更改请求接口数据
                .getConsumeRecord(params)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getConsumeRecord(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.getConsumeRecord(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public interface OnCallBack{
        void getConsumeRecord(boolean isSuccess, Object object);
